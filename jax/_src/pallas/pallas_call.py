...
def _pallas_call_batching_rule(
  ...
  if lengths_aval:
    ...
    def when_wrapped_kernel(lengths_ref, *args, **kwargs):
      ...
      def f():
        ...
        with pallas_core.tracing_grid_env(
            grid_mapping.grid,
            (),
            grid_mapping.positional_full_and_block_arg_shapes,
        ):
    ...
    with pallas_core.tracing_grid_env(
        ...
        (),
        batched_grid_mapping.positional_full_and_block_arg_shapes,
    ):
...
def checkify_pallas_kernel_body_jaxpr(
  ...
  with pallas_core.tracing_grid_env(
      grid_mapping.grid, (), grid_mapping.positional_full_and_block_arg_shapes
  ):
